...
# -----------------------------
data = sio.loadmat("../../data/data_EDP3-2.mat")
...
distribution_param_files = {
    'Normal': '../best_model/model_optimization_results_ngboost_normal_EDP3-2.mat',
    'LogNormal': '../best_model/model_optimization_results_ngboost_lognormal_EDP3-2.mat'
}
